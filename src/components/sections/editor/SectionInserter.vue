...
<template>
  <div class="flex items-center justify-center py-2 group/inserter">
    <button
      class="flex items-center gap-1 px-3 py-1.5 text-xs text-gray-400 hover:text-gray-600 rounded-full hover:bg-gray-100 transition-opacity duration-fast delay-100 opacity-0 group-hover/inserter:opacity-100"
